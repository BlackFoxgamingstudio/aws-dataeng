#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-aws-dataeng
Listens on port 8801 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8801), WebhookHandler)
    print(f"[Sovereign Aws Dataeng] Webhook Adapter listening on http://0.0.0.0:8801")
